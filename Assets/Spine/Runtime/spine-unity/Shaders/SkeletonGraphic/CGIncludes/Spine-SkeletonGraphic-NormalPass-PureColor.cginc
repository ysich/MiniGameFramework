#ifndef SKELETON_GRAPHIC_NORMALPASS_PURECOLOR_INCLUDED
#define SKELETON_GRAPHIC_NORMALPASS_PURECOLOR_INCLUDED
...
fixed4 frag (VertexOutput IN) : SV_Target
{
    ...
    color.rgb = _PureColor.rgb * _PureColor.a + color.rgb * (1 - _PureColor.a);
