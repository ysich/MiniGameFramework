...
Shader "Spine/SkeletonGraphic Mask"
{
	Properties
	{
		...
		[NoScaleOffset] _MaskTex ("遮罩贴图", 2D) = "black" {}
		_Color ("主色调", Color) = (1,1,1,1)
		_TintColor2 ("亮部颜色", Color) = (1,1,1,1)
		_TintColor3 ("暗部颜色", Color) = (1,1,1,1)
		_TintColor4 ("高光颜色", Color) = (1,1,1,1)
		_MainTexPolar("亮部强度(X) 暗部强度(Y) 高光强度(z)", Vector) = (1,1,1,1)
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag (VertexOutput IN) : SV_Target
			{
				...
				half3 c1 = maskColor.r * _TintColor2.rgb * _TintColor2.a * _MainTexPolar.x;
				half3 c2 = maskColor.g * _TintColor3.rgb * _TintColor3.a * _MainTexPolar.y;
				half3 c3 = maskColor.b * _TintColor4.rgb * _TintColor4.a * _MainTexPolar.z;
				texColor.rgb = texColor.rgb + c1 + c2 + c3;
